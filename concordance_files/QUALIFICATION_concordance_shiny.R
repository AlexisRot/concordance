...

{
  ...
  pdf(file = paste(LOCATIONout, "concordance", ".", Postfix, ".pdf", sep = ""), 
...
)
{
  ...
  write.html.tablen(file= paste(LOCATIONout, "concordance", ".", Postfix, ".html",sep=""), Qualification.Table,
  ...
  write.html.tablen(file= paste(LOCATIONout, "concordance", ".", Postfix, ".html",sep=""), GMT.Ratio.Table,
  ...
  {
    colnames( Serostatus.Agreement.Table) <- c("Parameter","Estimates",AlphaCI.Low, AlphaCI.Upp)
    write.html.tablen(file= paste(LOCATIONout, "concordance", ".", Postfix, ".html",sep=""),  Serostatus.Agreement.Table, 
  ...
  write.html.tablen(file= paste(LOCATIONout, "concordance", ".", Postfix, ".html",sep=""), AltmanBland.Table,
